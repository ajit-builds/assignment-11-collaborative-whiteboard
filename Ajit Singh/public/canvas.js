 ...
 * Student: Ajit Singh (150096725184)
 */
...
(() => {
  ...
  const defaultUserNames = ['Alice', 'Bob', 'Charlie', 'Ajit', 'Dev', 'Alex', 'Sam'];
  const defaultColors = ['#ff5722', '#3b82f6', '#10b981', '#ec4899', '#8b5cf6', '#f59e0b'];

  let currentUser = {
    username: localStorage.getItem('collab_username') || ('Ajit_' + Math.floor(Math.random() * 900 + 100)),
